...
+ 将应用程序busybox运行在内核态
  ...
  从开始完全不懂linux内核裁剪，到最后的结果可以满足实验要求，整个课程中非常感谢**杨海宇同学**[a](https://github.com/ir193/)以及**杨松霖同学**[b](https://github.com/SunliyMonkey/)的帮助！！感谢他们能够抽出时间不厌其烦地回答我的问题，细心帮我解决实验中所遇到的问题！！
