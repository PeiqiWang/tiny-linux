...
# -MD kernel/.bounds.s.d /home/child/my-linux/linux-4.0.4/kernel/bounds.c
...
# -mno-3dnow -mno-avx -march=x86-64 -auxbase-strip kernel/bounds.s -O2
...
foo:
	...
	movq	%rsp, %rbp	#,
#APP
# 18 "/home/child/my-linux/linux-4.0.4/kernel/bounds.c" 1
	
->NR_PAGEFLAGS $23 __NR_PAGEFLAGS	#
# 0 "" 2
# 19 "/home/child/my-linux/linux-4.0.4/kernel/bounds.c" 1
	
->MAX_NR_ZONES $4 __MAX_NR_ZONES	#
# 0 "" 2
# 21 "/home/child/my-linux/linux-4.0.4/kernel/bounds.c" 1
	
->NR_CPUS_BITS $6 ilog2(CONFIG_NR_CPUS)	#
# 0 "" 2
# 23 "/home/child/my-linux/linux-4.0.4/kernel/bounds.c" 1
