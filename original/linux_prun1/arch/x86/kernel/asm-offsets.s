...
main:
	...
	movq	%rsp, %rbp	#,
#APP
# 33 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->TI_sysenter_return $40 offsetof(struct thread_info, sysenter_return)	#
# 0 "" 2
# 34 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->
# 0 "" 2
# 37 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_ax $44 offsetof(struct sigcontext_ia32, ax)	#
# 0 "" 2
# 38 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_bx $32 offsetof(struct sigcontext_ia32, bx)	#
# 0 "" 2
# 39 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_cx $40 offsetof(struct sigcontext_ia32, cx)	#
# 0 "" 2
# 40 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_dx $36 offsetof(struct sigcontext_ia32, dx)	#
# 0 "" 2
# 41 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_si $20 offsetof(struct sigcontext_ia32, si)	#
# 0 "" 2
# 42 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_di $16 offsetof(struct sigcontext_ia32, di)	#
# 0 "" 2
# 43 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_bp $24 offsetof(struct sigcontext_ia32, bp)	#
# 0 "" 2
# 44 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_sp $28 offsetof(struct sigcontext_ia32, sp)	#
# 0 "" 2
# 45 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_SIGCONTEXT_ip $56 offsetof(struct sigcontext_ia32, ip)	#
# 0 "" 2
# 46 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->
# 0 "" 2
# 49 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_RT_SIGFRAME_sigcontext $164 offsetof(struct rt_sigframe_ia32, uc.uc_mcontext)	#
# 0 "" 2
# 50 "/home/child/my-linux/linux-4.0.4/arch/x86/kernel/asm-offsets_64.c" 1
